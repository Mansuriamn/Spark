...
const Footer = () => {
  return (
    <footer id="site-footer" className="footer-section bg-purple-700 text-white px-6 py-12">
  <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between gap-8">
    {/* Logo & Description */}
    <div id="footer-logo" className="footer-col w-full sm:w-1/4 mb-10 text-center sm:text-left">
    ...
    <div id="footer-help" className="footer-col w-full sm:w-1/4 mb-10 font-semibold text-center sm:text-left">
      ...
      <ul className="space-y-1 text-purple-100">
        ...
        <li><a href="#" className="hover:text-orange-400">Development</a></li>
        <li><a href="#" className="hover:text-orange-400">AI & ML</a></li>
        <li><a href="#" className="hover:text-orange-400">Data Science</a></li>
        <li><a href="#" className="hover:text-orange-400">Finance</a></li>
        <li><a href="#" className="hover:text-orange-400">Health</a></li>

      </ul>
    </div>

    {/* Programs */}
    <div id="footer-programs" className="footer-col w-full sm:w-1/4 mb-10 font-semibold text-center sm:text-left">
