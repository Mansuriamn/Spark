...
import { Edit3, Mail, User, BookOpen, Clock, Users, Camera, Upload } from 'lucide-react';
  ...
  const enrolledCourses = [
    {
      ...
      description: 'Punctuation — learn the basics without the pain. People will never laugh at your punctuation again.',
      progress: 75,
      level: 'Advanced',
      participants: 4,
    ...
    },
    {
      ...
      description: 'Master technical Spanish vocabulary and communication skills for professional environments.',
      progress: 45,
      level: 'Beginner',
      participants: 8,
