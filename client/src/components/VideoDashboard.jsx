              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                  <div className="aspect-video bg-gradient-to-br from-gray-900 to-gray-700 flex items-center justify-center relative">
                    ...
                    <button 
                      className="relative z-10 bg-white bg-opacity-20 backdrop-blur-sm rounded-full p-6 hover:bg-opacity-30 transition-all duration-300 transform hover:scale-110"
                      onClick={() => setSelectedVideo(videoSections[1].videos[0])}
                    >
